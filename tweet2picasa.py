...
def main():
	parser = argparse.ArgumentParser(description='Post all twitpic tweets to Picasa. Only supports public timelines and can only handle max 200 tweets back in time.')
